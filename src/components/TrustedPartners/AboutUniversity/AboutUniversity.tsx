...
const AboutUniversity: React.FC = () => {
    ...
    const fetchUniversity = async () => {
      ...
      try {
        ...
        const publicRes = await fetch(
          `${BASE_URL}/universities/details/${id}`,
          {
            headers: {
  ...
  const handleImageError = (
    ...
    console.error(
      `Image ${index} failed to load. Original src: ${e.currentTarget.src}`
    );
    ...
    if (university?.images[index]) {
      ...
      if (originalPath.startsWith("storage/")) {
        alternativeUrl = `${BASE_URL.replace(
          "/api",
          ""
        )}/uploads/${originalPath.replace("storage/", "")}`;
      } else if (originalPath.startsWith("uploads/")) {
        alternativeUrl = `${BASE_URL.replace(
          "/api",
          ""
        )}/storage/${originalPath.replace("uploads/", "")}`;
    ...
    e.currentTarget.className =
      "w-full h-full object-contain object-center bg-gray-100 p-4";
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                onClick={() => navigate("/university")}
                className="px-5 py-2.5 border border-primary text-secondary font-medium rounded-lg hover:bg-primarytransition-colors flex items-center justify-center gap-2"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
          ...
          {university.images && university.images.length > 0 ? (
                  ...
                  >
                    {hasError ? (
                      ...
                      <>
                        <img
                          src={imageUrl}
                          alt={`${university.university_name} - Photo ${
                            index + 1
                          }`}
            ...
            <div className="bg-white rounded-xl shadow-sm border p-12 text-center">
              ...
              <p className="text-gray-400">
                This university hasn't uploaded any photos yet.
              </p>
            </div>
          )}
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-blue-50 rounded-xl p-5">
                    ...
                    <p className="text-gray-700 mb-2">
                      ...
                      {university.average_graduate_program || "N/A"}
                    </p>
                    <p className="text-gray-600 text-sm">
                      {university.average_graduate_program_short_desc ||
                  ...
                  <div className="bg-green-50 rounded-xl p-5">
                    ...
                    <p className="text-gray-700 mb-2">
                      <span className="font-medium">Duration:</span>{" "}
                      {university.average_undergraduate_program || "N/A"}
                    </p>
                    <p className="text-gray-600 text-sm">
                      {university.average_undergraduate_program_short_desc ||
                        "Information not available"}
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    ...
                    <span className="font-semibold">
                      {university.dli_number || "N/A"}
                    </span>
                  </div>
                  <div className="flex justify-between items-center py-2">
                    <span className="text-gray-600">Application Fee</span>
                    <span className="font-semibold">
                      {university.application_fee || "N/A"}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border p-6">
                ...
                <div className="mt-6 pt-6 border-t border-gray-100 space-y-3">
                  <button className="w-full bg-secondary text-white font-medium py-3 rounded-lg hover:bg-primary transition-colors">
                    Request More Information
                  </button>
                  <button className="w-full border border-secondary text-secondary font-medium py-3 rounded-lg hover:bg-blue-50 transition-colors">
