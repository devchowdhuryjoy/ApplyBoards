...
//         <div className="w-64 h-96 bg-gradient-to-br from-blue-600 to-blue-400 rounded-3xl overflow-hidden flex items-center justify-center shadow-lg">
//           <img
...
//           {/* Acceptance Rate Box */}
//           <div className="bg-blue-600 text-white rounded-2xl p-6 w-56 shadow-md text-center">
...
//           {/* Supporting Image */}
//           <div className="w-56 h-36 rounded-2xl overflow-hidden shadow-md">
//             <img
