          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="px-4 py-2 md:px-5 md:py-1.5 text-sm md:text-xs border border-primary text-secondary font-medium rounded-lg hover:bg-primary/10 transition-colors flex items-center justify-center gap-2"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
