...
const RegistrationAgent: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const updatedFormData = {
      ...
      college_students: "0",
      creative_course: "0",
      university_preparation: "0",
      adult_english: "0",
      junior_english: "0",
      direct_entry: "0",
      company_year: currentYear.toString(),
      branch_offices: "0",
      counsellors: "0",
      year_established: `${currentYear}-01-01`,
      college: "0",
      hear_about: formData.source_info || "Not specified",
    };
    ...
    <div className="min-h-screen bg-white mb-10">
      ...
      <div className="text-black py-12 px-6 text-center">
        ...
        <p className="max-w-3xl mx-auto leading-relaxed text-justify hyphens-auto">
          With our 2-year history, we have built strong relationships with over
          1000 recruitment partners, providing educational opportunities for
          students from over 50 countries. If you would like to partner with
          Study-XL International please complete the below form and a
