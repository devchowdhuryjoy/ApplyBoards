...
// import PersonalDetails from './StudentProfileAllPage/PersonalDetails';
// import Education from './StudentProfileAllPage/Education';
// import TravelImmigration from './StudentProfileAllPage/TravelImmigration';
// import RefereeDetails from './StudentProfileAllPage/RefereeDetails';
// import WorkDetails from './StudentProfileAllPage/WorkDetails';
// import Documents from './StudentProfileAllPage/Documents';
// import FinalSubmission from './StudentProfileAllPage/FinalSubmission'; // Import FinalSubmission
// import { useNavigate } from 'react-router-dom'; // For navigation after completion
...
//     { id: 'submit', label: 'Review & Submit' }, // Add submit section
//   ];

//   // Handle completion of form - navigate to students list or dashboard
//   const handleFormComplete = () => {
//     // You can navigate to any page you want after successful submission
//     // For example, go to students list or dashboard
//     navigate('/agent/students'); // Adjust this path according to your routing
//   };

//   const renderComponent = () => {
//     switch(activeSection) {
//       case 'personal': 
//         return <PersonalDetails goToSection={setActiveSection} />;
//       case 'education': 
//         return <Education goToSection={setActiveSection} />;
//       case 'travel': 
//         return <TravelImmigration goToSection={setActiveSection} />;
//       case 'referee': 
//         return <RefereeDetails goToSection={setActiveSection} />;
//       case 'work': 
//         return <WorkDetails goToSection={setActiveSection} />;
//       case 'documents': 
//         return <Documents goToSection={setActiveSection} />;
//       case 'submit': 
...
//       {/* Sidebar */}
//       <div className={`bg-primary text-white md:w-64 w-64 md:block fixed md:relative inset-y-0 left-0 transform md:translate-x-0 transition-transform duration-300 z-50 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}>
...
//               <button
//                 key={item.id}
//                 className={`text-left px-4 py-3 rounded-md font-medium text-sm transition-colors duration-200 ${
...
//             className="p-2 rounded-lg bg-primary text-white hover:bg-secondary transition"
//           >
//             ☰ Menu
//           </button>
//         </div>
...
import WorkDetails from './StudentProfileAllPage/WorkDetails';
import Documents from './StudentProfileAllPage/Documents';
import FinalSubmission from './StudentProfileAllPage/FinalSubmission';
// import { useNavigate } from 'react-router-dom';

interface StudentsProfileProps {
  onComplete: () => void;
}
// const StudentsProfile = () => {
const StudentsProfile: React.FC<StudentsProfileProps> = ({ onComplete }) => {
  const [activeSection, setActiveSection] = useState('personal');
  const [sidebarOpen, setSidebarOpen] = useState(false);
  const [fileInputs, setFileInputs] = useState({}); // Add state for files
  // const navigate = useNavigate();
  ...
  // Handle files selected from Documents component
  const handleFilesSelected = (key, files) => {
    setFileInputs(prev => {
      const updated = {
        ...prev,
        [key]: files
      };
      console.log('Updated fileInputs:', updated); // For debugging
      return updated;
    });
  };
      ...
      case 'submit': 
        return (
          <FinalSubmission 
            ...
            fileInputs={fileInputs} // Pass the files to FinalSubmission
          />
        );
      default: 
        return <PersonalDetails goToSection={setActiveSection} />;
